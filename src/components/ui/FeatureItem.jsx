  ...
  return (
    <div className="flex flex-col justify-start items-start gap-0 font-inter">
      <div className="flex justify-start items-center gap-2">
        <div className="bg-primaryColor/20 border-2 border-primaryColor w-8 h-8 min-w-8 min-h-8 rounded-full flex justify-center items-center p-2 translate-y-0.5">
