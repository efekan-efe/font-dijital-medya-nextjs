...
const ServiceBlock = ({ badgeContent, title, children, imageSrc, imageAlt, imagePosition = "right" }) => {
  return (
    <div className={`max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 font-inter ${imagePosition === "left" ? "lg:flex-row-reverse" : ""}`}>
      <div className="flex-1 flex flex-col items-start gap-y-6">
        {badgeContent}
