...
const HeroSection = () => {
  ...
  return (
    ...
    <section ref={container} className="max-w-7xl mx-auto px-2 py-8 font-inter max-md:py-4 h-full flex items-center">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center w-full">
        {/* Sol Sütun */}
